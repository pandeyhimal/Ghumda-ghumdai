...
import { createContent, uploadImages } from "../controllers/ContentController.js";
...
const createContentValidators = [
  ...
  body("rating").optional({ values: "falsy" }).isFloat({ min: 0, max: 5 }).withMessage("Rating must be 0-5"),
  ...
  body("tags").optional({ values: "falsy" }).isArray().withMessage("Tags must be an array of strings"),
